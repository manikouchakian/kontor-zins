...
class AnnuityTest {
    ...
    @Test
    @DisplayName("splits the principal evenly when the rate is zero")
    ...
    @Test
    @DisplayName("a higher rate means a higher payment")
    ...
    @Test
    @DisplayName("a longer term means a lower payment")
    ...
    @Test
    @DisplayName("rejects a negative principal")
    ...
    @Test
    @DisplayName("rejects a term of zero months")
